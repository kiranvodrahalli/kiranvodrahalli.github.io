...
<img src="{{ site.baseurl }}/research/reports/cos513/lydia-variance-eeg.jpg" />

Across trials, the data seems to behave very differently.

Here is a <a href= "{{ site.baseurl }}/research/reports/cos513/post7.pdf" title= "summary-7"> summary </a> of the results. 
...
<img src="{{ site.baseurl }}/research/reports/cos513/framework.jpg" />
...
<img src="{{ site.baseurl }}/research/reports/cos513/5fftcoefs.jpg" />
...
<img src="{{ site.baseurl }}/research/reports/cos513/306energies_c1-3.jpg" />
...
<img src="{{ site.baseurl }}/research/reports/cos513/HighestCorrCanonVect.png" />

When we set \\(K = 40\\), this is what the highest correlation canonical vector plot looks like. The correlation was \\(0.98\\).
<img src="{{ site.baseurl }}/research/reports/cos513/highestcorrK40_31.png" />
...
<img src="{{ site.baseurl }}/research/reports/cos513/tmap1.png" />
...
<img src="{{ site.baseurl }}/research/reports/cos513/meg_fmri_scca.png" />

Here we visualize the values of the highest correlation canonical vector for the fMRI-t-values.
<img src="{{ site.baseurl }}/research/reports/cos513/entries_MEG.png" />
...
- Correlation \\(1\\) is bad and indicates overfitting. Thus we try reducing dimensions.
	...
	- We plot the values in the transformed space \\(M, N\\) for one dimension: <img src="{{ site.baseurl }}/research/reports/cos513/canonCorr-labelled.png" />
...
- Then we found a different package implementing CCA which allowed us to use regularization on regular CCA, since Matlab did not have regularization parameters
	...
	- We also plotted the covariance for one of the dimensions (\\(M, N\\) for one dimension): <img src="{{ site.baseurl }}/research/reports/cos513/KCCAcomp11.png" />
...
- Bayesian CCA Model 
	...
	- <img src="{{ site.baseurl }}/research/reports/cos513/bcca_train_plot.png" />
	...
	- <img src="{{ site.baseurl }}/research/reports/cos513/bcca_test_plot.png" />
...
- mCCA vs jICA (2008)
	...
	- Compares mCCA with jICA:
		- <img src="{{ site.baseurl }}/research/reports/cos513/mCCA-vs-jICA.png" />
...
<img src="{{ site.baseurl }}/research/reports/cos513/eeg-raw.jpg" />
...
<img src="{{ site.baseurl }}/research/reports/cos513/eeg-ica.jpg" />
...
<img src="{{ site.baseurl }}/research/reports/cos513/eegICAcompstats.png" />
...
<img src="{{ site.baseurl }}/research/reports/cos513/EEGcorr.png" />
...
<img src="{{ site.baseurl }}/research/reports/cos513/EEGcrossCov.png" />
...
<img src="{{ site.baseurl }}/research/reports/cos513/fmri-brain-vis.jpg" />
...
<img src="{{ site.baseurl }}/research/reports/cos513/BOLD_hist_s2t1r2.png" />
...
<img src="{{ site.baseurl }}/research/reports/cos513/Mean_bold_and_pcs.png" />

Here we plot a correlation matrix for each TR: At each time step, we calculate covariance by summing over voxels. 
<img src="{{ site.baseurl }}/research/reports/cos513/fmriCorr_time.png" />
...
<img src="{{ site.baseurl }}/research/reports/cos513/corr_BOLD_subset_of_voxels.png" />
