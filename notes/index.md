...
* What Can ResNets Learn Efficiently? [[pdf]](resnet-kernel-separation.pdf) (for Simons Summer 2019 Reading Group on Generalization Theory)
* Geometry of Optimal Transport [[pdf]](villani-ch2.pdf) (for Simons Summer 2019 Reading Group on Optimal Transport)
...
* COMS 6998-9: Algorithms for Massive Data <a href= "{{ site.baseurl }}/notes/coms-big-data-algs-scribe.pdf" title="big-data">[pdf]</a> [[course website]](http://www.mit.edu/~andoni/algoS19/index.html)
* COMS 4995-2: Unsupervised Learning <a href= "{{ site.baseurl }}/notes/nov-26-18-uml-notes.pdf" title="unsupervised-verma">[pdf]</a> [[course website]](http://www.cs.columbia.edu/~verma/classes/uml/index.html)
...
* ORF 524: Statistical Theory and Methods <a href= "{{ site.baseurl }}/notes/orf524_scribe.pdf" title="orf524">[scribe notes]</a> [[syllabus]](http://www.columbia.edu/~skk2175/Courses/Syllabus524.pdf)
* MAT 529: Metric Embeddings and Geometric Inequalities (taught by [Assaf Naor](https://web.math.princeton.edu/~naor/)) <a href= "{{ site.baseurl }}/notes/mat529_notes.pdf" title="529metric">[pdf]</a> (with Holden Lee)
* MAT 597/PHY521: Mathematical Physics (taught by [Michael Aizenman](https://www.princeton.edu/~aizenman/)) <a href= "{{ site.baseurl }}/notes/mat597_notes.pdf" title="529randomgraphs">[pdf]</a> (with Holden Lee)
* APC 529: Coding Theory and Random Graphs (taught by [Emmanuel Abbe](https://web.math.princeton.edu/~eabbe/)) <a href= "{{ site.baseurl }}/notes/529_random-graphs.pdf" title="529randomgraphs">[pdf]</a>
* MAT 340: Applied Algebra (taught by [Mark McConnell](https://www.math.princeton.edu/people/mark-mcconnell)) <a href= "{{ site.baseurl }}/notes/340_notes.pdf" title="340alg">[pdf]</a> 
* CS 224d: Deep Learning for Natural Language Processing (taught by [Richard Socher](https://www.socher.org/)) [[scribe notes]](liveTeX/socher_last_lec_224d.pdf) 
...
* COS 510: Programming Languages (taught by [David Walker](https://www.cs.princeton.edu/~dpw/)) <a href= "{{ site.baseurl }}/notes/curry_howard_cos510notes.pdf" title="cos510notes"> [scribe notes] </a> 
* APC 486: Transmission and Compression of Information (taught by [Emmanuel Abbe](https://web.math.princeton.edu/~eabbe/)) <a href= "{{ site.baseurl }}/notes/apc486_kiran_scribe_notes.pdf" title="apc486notes"> [scribe notes] </a>
